...
static const char *fonts[]          = { "monospace:size=12", "Sarasa Mono SC:size=12" };
static const char dmenufont[]       = "monospace:size=12";
static const char col_sel_text[]    = "#eeeeee";
static const char col_sel_back[]    = "#186a3b";
static const char col_sel_bord[]    = "#186a3b";
...
/* tagging */
// TODO: Use unicode font instead of numbers
...
static const char *rofimenu[]  = { "rofi", "-show", "combi" };
...
static const char *upvol[]     = { "/bin/sh", "-c", "/usr/bin/pactl set-sink-volume 0 +5% && pkill -2 dwmbar",  NULL };
static const char *downvol[]   = { "/bin/sh", "-c", "/usr/bin/pactl set-sink-volume 0 -5% && pkill -2 dwmbar",  NULL };
static const char *mutevol[]   = { "/bin/sh", "-c", "/usr/bin/pactl set-sink-mute 0 toggle && pkill -2 dwmbar", NULL };
static const char *uplight[] = { "/bin/sh", "-c", "light -A 10 && pkill -2 dwmbar", NULL };
static const char *downlight[] = { "/bin/sh", "-c", "light -U 10 && pkill -2 dwmbar", NULL };
static const char *calibratelight[] = {"busctl", "--user", "call", "org.clight.clight", "/org/clight/clight", "org.clight.clight", "Calibrate"};
...
static Key keys[] = {
  ...
  { MODKEY,                       XK_slash, spawn,           {.v = calibratelight } },
